  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col gap-6 py-12" data-testid="login-page">
      <div className="text-center">
        <h1 className="font-serif text-2xl font-bold text-warm-800">Welcome back</h1>
        <p className="mt-1 text-sm text-warm-500">Sign in to continue creating stories</p>
      </div>

      <form onSubmit={handleSubmit} className="flex flex-col gap-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-warm-200/60">
        <div className="space-y-1">
          <label className="text-sm font-medium text-warm-700" htmlFor="login-email">Email</label>
          <input
            id="login-email"
            type="email"
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-warm-700" htmlFor="login-password">Password</label>
          <input
            id="login-password"
            type="password"
            className="w-full rounded-lg border border-warm-200 px-4 py-2.5 text-sm focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/20"
